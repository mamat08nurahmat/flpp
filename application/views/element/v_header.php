...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset/datepicker/css/bootstrap-datepicker.css')?>"/>	
            ...
            <div class="navbar-inner">
                <div class="container">
                    <ul class="nav">
                        ...
                        <li>
                            <a href="<?php echo site_url('upload')?>"><i class="icon-edit"></i> Upload</a>
                        </li>
<!----dev---->						
                        <li>
                            <a href="<?php echo site_url('laporan/generate1')?>"><i class="icon-file"></i>Generate</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('laporan/detail')?>"><i class="icon-file"></i>Laporan Detail</a>
                        </li>
						
                        <li>
                            <a href="<?php echo site_url('laporan/total')?>"><i class="icon-file"></i>Laporan Total</a>
                        </li>
<!-----DEVELOP NEXT

--->						
                        <li>
                            <a href="<?php echo site_url('clean')?>"><i class="icon-file"></i>Clean</a>
                        </li>
<!---
...
--->						
                        ...
                        <li>
						<a href="<?php echo site_url('login/logout')?>" style="background: #333; color: #fff";>
						<i class="icon-white icon-remove-sign"></i>Logout
						</a>
						</li>
                    </ul>
                </div>
