...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div id="laporanPage">
            <form class="form-horizontal" method="post" action="<?= site_url('laporan/cari_generate1')?>">
                <div class="control-group">
                    <label class="control-label" for="start_date">Batch ID</label>
                    <div class="controls">
<!----AJAX onchange--->					
                        <select id="batch_id" tabindex="5" class="chzn-select" name="batch_id" data-placeholder="Pilih Batch ID">
                            <option value=""></option>
                            <?php
                            if(isset($data_upload_batch)){
                                foreach($data_upload_batch as $row){
                                    ?>
