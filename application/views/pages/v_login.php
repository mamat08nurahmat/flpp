        ...
        <div class="animate form login_form">
          <section class="login_content">
           <form class="form-signin" action="<?= site_url('login/cek_login')?>" method="post">  
              <h1>Login Form</h1>
              <div>
                <input type="kd_user" class="form-control" name="kd_user" placeholder="Kode User" required="" />
              </div>
              <div>
...
<!---
                <a class="reset_pass" href="#" onclick="return confirm('email: admin123@bni.co.id  pass: ')">Lost your password?</a>
-->			  
