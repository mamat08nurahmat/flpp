...
<!-----
    <div class="row-fluid">
        <div id="laporanPage">
            <form class="form-horizontal" method="post" action="<?= site_url('clean/cari_upload')?>">
                <div class="control-group">
                    <label class="control-label" for="start_date">BATCH ID</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <div class="controls">
                        <button id="btnCari" type="submit" class="btn btn-info"><i class="icon icon-white icon-search"></i> Cleansing Upload</button>
                    </div>
                </div>
            </form>
        </div>
...
--->
    ...
    <div class="row-fluid">
        <div id="laporanPage">
            <form class="form-horizontal" method="post" action="<?= site_url('clean/hapus_batch')?>">
                <div class="control-group">
                    <label class="control-label" for="start_date">BATCH ID</label>
                    <div class="controls">
